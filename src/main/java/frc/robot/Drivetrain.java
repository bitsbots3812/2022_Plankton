...
public class Drivetrain {
    ...
    Drivetrain(int CanIdFL, int CanIdFR, int CanIdRL, int CanIdRR, boolean FLInversion, boolean FRInversion, boolean RLInversion, boolean RRInversion) {
    ...
    void drive(DriverControlsMap controls, ManipulatorControlsMap manipulatorControls, RobotState state, double NavxRotation, PixyInterface pixy, LimelightInterface limelight) {
        switch (state.currentLockMode) {
            ...
            case PIXY: {
                ...
                pixy.steeringSuggestion(state.selectedColor)*0.2);
                break;
            }
            case LIMELIGHT: {
